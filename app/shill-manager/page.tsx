...
import { Bot, Settings, MessageSquare, Wand2, Users, BarChart2 } from "lucide-react"
          ...
          >
            <div className="flex flex-col gap-4">
              ...
              <p className="text-muted-foreground max-w-2xl">
                Let AI handle your social media presence while you focus on building. Our advanced shill bot uses
                natural language processing to engage with your community and promote your token.
              </p>
            </div>
          </motion.div>
