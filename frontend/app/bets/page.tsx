          ...
          >
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
              <div>
                ...
                <p className="text-muted-foreground">Place your bets and challenge others on future events</p>
              </div>
              <div className="flex items-center gap-4">
                ...
                <div className="flex items-center gap-2 bg-black/40 backdrop-blur-sm rounded-full px-4 py-2 border border-white/10">
                  <div className="text-sm">
                    ...
                    <span className="font-mono font-medium text-white">$1,234,567</span>
                  </div>
                  <div className="w-px h-4 bg-white/10" />
                  <div className="text-sm">
                    <span className="text-gray-400">Active Bets:</span>{" "}
                    <span className="font-mono font-medium text-white">{activeBets.length}</span>
                  </div>
                </div>
              </div>
            </div>
